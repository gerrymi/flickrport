...
app.factory('flickrPort', function($http, $routeParams) {
    ...
    flickrPort.prototype.nextPage = function() {
		...
		this.busy = true;
      	...
      	$http.get("https://api.flickr.com/services/rest/?method=flickr.photosets.getList&api_key=9925e9fc9654b7141240423e98da68e6&user_id="+this.user_id+"&format=json&nojsoncallback=1").then(function(res){
